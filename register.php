...
<html lang="en">
<head>
<title>Crime Rate Prediction | User Register</title>
<!-- for-mobile-apps -->
...
<div class="services-w3layouts" id="services">
	...
	<div class="head-top-w3ls"></div>
		<h5 class="title-w3">User Registration</h5>
		<div class="col-md-12 col-md-offset-4">
				...
				<div class="col-md-4">
					...
					<div >
						<br>
						<input type="text" id="txtMobile" class="form-control" placeholder="Mobile" >
					</div>
					<div >
						<br>
					...
					<br>
					<h3>
					<a onclick="RegisterUser();"  style="cursor: pointer;"><span class="label label-primary">Register</span></a></h3>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
...
<script src="js/responsiveslides.min.js"></script>
	...
	function RegisterUser(){
		...
		if($("#txtName").val()==""){
		...
		else if($("#txtMobile").val().length!=10 || $("#txtMobile").val().match(pattern)){
			...
			$.ajax({
				...
				data:{name:$("#txtName").val(),email:$("#txtEmail").val(),mobile:$("#txtMobile").val(),dateofbirth:$("#txtDateOfBirth").val(),interest:$("#selectInterest").val(),password:$("#txtPassword").val()},
