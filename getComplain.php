<?php
	...
	$db=new DB_Connect();
	$con=$db->connect();
	$qry="select * from crp_complain order by id desc";
	//echo $qry;
	$run=mysqli_query($con,$qry);
	$i=1;
	$table="";
	$table.="<thead><tr><th>Sr No</th><th>Crime</th><th>User Name</th><th>Mobile</th><th>Email</th><th>Location</th><th>Sub Location</th><th>Complain Description</th><th>Status</th><th>View</th></tr></thead><tbody>";		
