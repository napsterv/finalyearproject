...
$qry="select * from crp_user_login where id='".$_SESSION["userid"]."'";
...
<html lang="en">
<head>
<title>Crime Rate Prediction | User Home</title>
<!-- for-mobile-apps -->
...
<!-- //main-content -->
		...
		<!-- About-page -->
			<div class="container">
			<div class="a">
				<h1 style="text-align:center"><font color="red">Welcome <?php echo $name; ?></font></h2>
			</div>
			</div>
			</div>
<!--//about-->
